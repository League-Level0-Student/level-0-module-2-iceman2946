...
public class RollerCoaster {
	...
	public static void main(String[] args) {
			...
			String heightToRide=JOptionPane.showInputDialog("Can you enter your height in inches?");
			int heightAsInt=Integer.parseInt(heightToRide);
			// Uncomment the line below...		
			if( heightAsInt > 48 ) { 
				JOptionPane.showMessageDialog(null, "Hurray! You are tall enough to ride a roller coaster alone!");
			}
			else if(heightAsInt > 42) {
				JOptionPane.showMessageDialog(null, "You can ride the roller coaster with someone else!");
			}
			else {
				JOptionPane.showMessageDialog(null,"You must be 42 inches tall to ride the roller coaster pal!" );
			}
